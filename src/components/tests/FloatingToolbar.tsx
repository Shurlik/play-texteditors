...
import {FloatingToolbarAi} from "@/components/tests/FloatingToolbarAi";
...
export function FloatingToolbar() {
	...
	return createPortal(
		<div
			ref={setFloating}
			className="pointer-events-none floatingTb"
			style={
...
function ToolbarOptions({
	...
	return (
		<div className="w-full text-foreground text-sm leading-relaxed bg-white floatingTb">
